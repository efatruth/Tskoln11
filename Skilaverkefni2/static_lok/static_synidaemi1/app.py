    ...
    return '''
            ...
            <html>
                <head>
                    ...
                    <meta charset="utf-8">
                    <!-- notum route sem heitir static, skrá er í public möppu -->
                    <link rel="stylesheet" href="static/styles.css">
                </head>
                <body>
                    <h1>Halló heimur í bláum lit með CSS!</h1>
                    <!-- notum route sem heitir static skrá er í public möppu --> 
                    <img src="static/logo.png" alt="Bottle logo">
                </body>
            </html>
        '''
...
# stilla route svo hægt sé að vinna með static skrár (myndir og css)
@route('/static/<skra>')
